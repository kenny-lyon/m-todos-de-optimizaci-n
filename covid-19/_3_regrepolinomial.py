...
# Aplicar transformación polinomial (grado 2)
poly = PolynomialFeatures(degree=2, include_bias=False)
X_train_poly = poly.fit_transform(X_train)
X_test_poly = poly.transform(X_test)

# Entrenar modelo de regresión lineal (con características polinomiales)
...
plt.title("Valores reales vs predichos (Regresión Polinomial)")
